...
*height* (index of transpirational area and photosyn which affect growth

Height is considered a good estimate of photosynthetic capacity and transpirational area, suggesting a positive relationship with subsequent growth [@haase2007morphological].
...
Within a nursery environment maximum shoot growth occurs at high soil water regimes and moderate to high fertility levels [@mexal1990target].

Larger seedling height, however, may have adverse effects on field success in drier sites. This is mainly a issue of an imbalanced root:shoot ratio, which affects water uptake and the ability to develop new roots [cites from gross2012,@haase2007morphological], ].

Additionally, larger stock is adds difficulty in lifting, handling and planting properly, which can negate advantages of larger size tree stock in planting success [@cleary1978regenerating] 

*diameter* (most consistently related with plant performance above and bewloground which affect growth)

tree stock diameter (caliper) is tradionally viewed as a index for tree sturdiness [all cites], and potentially related to the size of the root system [@cleary1978regenerating, @wightman1999good].

Diameter has been shown to be postively related to seedling mass and outplanted seedling performance for a variety of nursery grown tree seedlings [@aphalo2003field, @wilson2006quality, @bayala2009predicting].
...
linear relationship between diameter and root volume was found for seedlings of northern red oak, white oak, and black cherry (Jacobs and Seifert 2004) and with red oak seedlings [@dey1997morphological]

stem diameter at the time of planting predicts of stem volume for several years after out-planting (Simpson
1995)

As stem diameter is easy to measure and is positive correlated with root system size, it is an operationally attractive morphological parameter for nursery grading criteria [@dey1997morphological].
