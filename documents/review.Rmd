...
In nusery trees, it is important that the shoot not be too tall relative to the stem diameter and that the shoot mass not be too large relative to the roots [@haase2008understanding]. A vigorous fast-growing shoot has to be supported and
...
A potential issue with the large increase in containerized seedlings is that seedlings are subject to root-binding and sprialling, which can negatively affect outplanting performance for years [@cleary1978regenerating]. J-rooting occurs when a seedling is inproperly planted into container growing media and can manifest into a source of structrual weakness at the soil interface as the tree grows [@moore2001nursery].
...
Containerized seedlings have a better survival rate, are easier to plant, have more immediate growth response benefits, and are cheaper to produce and plant than bareroot seedlings (Landis et al. 1990).
...
Trees grown in containers have been shown to develop root deformations [@ortega2006field], thus pruning managements (manual or container) is now common practive in manageing healthy root systems during nursery production.
...
Seedlings in larger containers will be larger than those of smaller containers, yet this may or may not affect survirorhsip of trees in the  years following outplanting. 
