...
*root pruning
Root pruning can vastly increase the surface area of the root system and increase the amount of roots within the root ball if properly managed [@watson1987effect].  As such, root pruning is commonly performed when transplanting into containers and represents an active management practive to increase the amount of resource absorbing roots and thus seedling quality. 
